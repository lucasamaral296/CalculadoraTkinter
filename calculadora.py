...
#Cores
#pesquisar cores no color picker
#escolha a cor e pegue seu codigo exadecimal
...
janela = Tk()
janela.title('Calculadora Lucas DEV')
janela.geometry('235x310')
janela.config(bg=cor1)

#criando frames(janelas)
